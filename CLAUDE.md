...
| Command | Description |
|---------|-------------|
| `/drvr:setup [clone-url]` | Set up a projects directory — configure MCP, create structure, verify connectivity |
...
| `/drvr:open-pr [feature-path]` | Open a pull request from handoff documentation generated by `/drvr:docs-artifacts` |
