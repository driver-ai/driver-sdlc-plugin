...
| `/drvr:capture-stop` | Stop rolling session capture -- flips the global flag; stored data is untouched | `/drvr:capture-stop` |
| `/drvr:capture-start` | Resume rolling session capture | `/drvr:capture-start` |
| `/drvr:capture-statusline` | Install or remove the "capturing" statusline badge (composes with an existing statusline) | `/drvr:capture-statusline` or `/drvr:capture-statusline remove` |
